...
class MedicineVendorDashboard extends StatelessWidget {
  const MedicineVendorDashboard({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Medicine Vendor Dashboard'),
        actions: [
          IconButton(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildActionCard(
                    ...
                    title: 'Prescriptions',
                    subtitle: 'View recent prescriptions',
                    color: AppTheme.secondaryColor,
                    onTap: () {
                      // TODO: Navigate to prescriptions list
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Prescriptions list coming soon!'),
                        ),
                      );
                    },
                  ),
                  ...
                  _buildActionCard(
                    ...
                    subtitle: 'Create and manage bills',
                    color: AppTheme.accentColor,
                    onTap: () {
                      // TODO: Navigate to bills management
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Bills management coming soon!'),
                        ),
                      );
                    },
                  ),
